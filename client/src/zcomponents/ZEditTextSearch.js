...
export default class ZEditTextSearch extends React.Component {  
	...
	render() {
		return (
			<div id={this.props.id} style={{position:"absolute",left:this.props.x,top:this.props.y,width:this.props.width,
				...
				<input id={this.props.id + 'button'} type="search"  style={{position:"absolute",left:this.props.button_x,top:this.props.button_y,width:this.props.button_width,
